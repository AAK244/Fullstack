**NOTE:** You can try out the parts of the application that require tokens with Exercise4.18 _Creating Users, Logging In, and Adding Blogs with the REST API Using PowerShell_ in the README.md file.
